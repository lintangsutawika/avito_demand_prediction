...
if args.deal == 'True':
    ...
    df['q1_deal_by_image_top_1'] = df['image_top_1'].map(df_train.groupby(['image_top_1'])['deal_probability'].transform('25%'))
    df['med_deal_by_image_top_1'] = df['image_top_1'].map(df_train.groupby(['image_top_1'])['deal_probability'].transform('50%'))
    df['q3_deal_by_image_top_1'] = df['image_top_1'].map(df_train.groupby(['image_top_1'])['deal_probability'].transform('75%'))
...
if args.mean == "True":
    ...
    df['q1_price_by_parent_category_name_user_type'] = df.groupby(['parent_category_name','user_type'])['price'].transform('quantile',p=0.25)
    df['med_price_by_parent_category_name_user_type'] = df.groupby(['parent_category_name','user_type'])['price'].transform('quantile',p=0.5)
    df['q3_price_by_parent_category_name_user_type'] = df.groupby(['parent_category_name','user_type'])['price'].transform('quantile',p=0.75)
    ...
    df['q1_price_by_item_seq_number'] = df.groupby(['item_seq_number'])['price'].transform('quantile',p=0.25)
    df['med_price_by_item_seq_number'] = df.groupby(['item_seq_number'])['price'].transform('quantile',p=0.5)
    df['q3_price_by_item_seq_number'] = df.groupby(['item_seq_number'])['price'].transform('quantile',p=0.75)
    ...
    df['q1_price_by_title_num_char'] = df.groupby(['title_num_char'])['price'].transform('quantile',p=0.25)
    df['med_price_by_title_num_char'] = df.groupby(['title_num_char'])['price'].transform('quantile',p=0.5)
    df['q3_price_by_title_num_char'] = df.groupby(['title_num_char'])['price'].transform('quantile',p=0.75)
    ...
    df['min_price_by_param_1'] = df.groupby(['param_1'])['price'].transform('min')
    df['q1_price_by_param_1'] = df.groupby(['param_1'])['price'].transform('quantile',p=0.25)
    df['med_price_by_param_1'] = df.groupby(['param_1'])['price'].transform('quantile',p=0.5)
    df['q3_price_by_param_1'] = df.groupby(['param_1'])['price'].transform('quantile',p=0.75)
    ...
    df['q1_price_by_region_day_of_week'] = df.groupby(['region','day_of_week'])['price'].transform('quantile',p=0.25)
    df['med_price_by_region_day_of_week'] = df.groupby(['region','day_of_week'])['price'].transform('quantile',p=0.5)
    df['q3_price_by_region_day_of_week'] = df.groupby(['region','day_of_week'])['price'].transform('quantile',p=0.75)
    ...
    df['q1_price_by_city'] = df.groupby(['city'])['price'].transform('quantile',p=0.25)
    df['med_price_by_city'] = df.groupby(['city'])['price'].transform('quantile',p=0.5)
    df['q3_price_by_city'] = df.groupby(['city'])['price'].transform('quantile',p=0.75)
    ...
    df['min_price_by_city_param_1'] = df.groupby(['city','param_1'])['price'].transform('min')
    df['q1_price_by_city_param_1'] = df.groupby(['city','param_1'])['price'].transform('quantile',p=0.25)
    df['med_price_by_city_param_1'] = df.groupby(['city','param_1'])['price'].transform('quantile',p=0.5)
    df['q3_price_by_city_param_1'] = df.groupby(['city','param_1'])['price'].transform('quantile',p=0.75)
    ...
    df['q1_price_by_city_image_top_1'] = df.groupby(['city','image_top_1'])['price'].transform('quantile',p=0.25)
    df['med_price_by_city_image_top_1'] = df.groupby(['city','image_top_1'])['price'].transform('quantile',p=0.5)
    df['q3_price_by_city_image_top_1'] = df.groupby(['city','image_top_1'])['price'].transform('quantile',p=0.75)
    ...
    df['q1_price_by_city_image_top_1_day_of_week'] = df.groupby(['city','image_top_1','day_of_week'])['price'].transform('quantile',p=0.25)
    df['med_price_by_city_image_top_1_day_of_week'] = df.groupby(['city','image_top_1','day_of_week'])['price'].transform('quantile',p=0.5)
    df['q3_price_by_city_image_top_1_day_of_week'] = df.groupby(['city','image_top_1','day_of_week'])['price'].transform('quantile',p=0.75)
    ...
    df['q1_price_by_city_category_name'] = df.groupby(['city','category_name'])['price'].transform('quantile',p=0.25)
    df['med_price_by_city_category_name'] = df.groupby(['city','category_name'])['price'].transform('quantile',p=0.5)
    df['q3_price_by_city_category_name'] = df.groupby(['city','category_name'])['price'].transform('quantile',p=0.75)
    ...
    df['q1_price_by_city_category_name_day_of_week'] = df.groupby(['city','category_name','day_of_week'])['price'].transform('quantile',p=0.25)
    df['med_price_by_city_category_name_day_of_week'] = df.groupby(['city','category_name','day_of_week'])['price'].transform('quantile',p=0.5)
    df['q3_price_by_city_category_name_day_of_week'] = df.groupby(['city','category_name','day_of_week'])['price'].transform('quantile',p=0.75)
    ...
    df['q1_image_top_1_by_city'] = df.groupby(['city'])['image_top_1'].transform('quantile',p=0.25)
    df['med_image_top_1_by_city'] = df.groupby(['city'])['image_top_1'].transform('quantile',p=0.5)
    df['q3_image_top_1_by_city'] = df.groupby(['city'])['image_top_1'].transform('quantile',p=0.75)
    ...
    df['q1_image_top_1_by_city_user_type'] = df.groupby(['city','user_type'])['image_top_1'].transform('quantile',p=0.25)
    df['med_image_top_1_by_city_user_type'] = df.groupby(['city','user_type'])['image_top_1'].transform('quantile',p=0.5)
    df['q3_image_top_1_by_city_user_type'] = df.groupby(['city','user_type'])['image_top_1'].transform('quantile',p=0.75)
