...
if args.mean == "True":
    ...
    df['q1_price_by_param_1'] = df.groupby(['param_1'])['price'].transform('quantile',q=0.25)
    ...
    df['q1_price_by_city_param_1'] = df.groupby(['city','param_1'])['price'].transform('quantile',q=0.25)
...
for train, valid in kf_.split(X):
    ...
    model = lgb.train(
        ...
        learning_rates=lambda iter:0.01 * (0.999 ** iter),
